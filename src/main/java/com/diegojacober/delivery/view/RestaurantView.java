...
public abstract class RestaurantView extends JFrame {
    ...
    private void initComponents() {
        ...
        jbtnItems = new JButton();
        jbtnOrders1 = new JButton();
        ...
        jbtnItems.setIcon(new ImageIcon(getClass().getResource("/com/diegojacober/delivery/img/items.png"))); // NOI18N
        jbtnItems.setBorder(null);
        jbtnItems.setFocusPainted(false);

        jbtnOrders1.setBackground(new java.awt.Color(0, 102, 102));
        jbtnOrders1.setIcon(new ImageIcon(getClass().getResource("/com/diegojacober/delivery/img/orders.png"))); // NOI18N
        ...
        jpMenuLayout.setHorizontalGroup(
            ...
            .addGroup(jpMenuLayout.createSequentialGroup()
                ...
                .addGroup(jpMenuLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(GroupLayout.Alignment.TRAILING, jpMenuLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(jpMenuLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addComponent(jbtnItems, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE)
                            .addComponent(jbtnOrders1, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        jpMenuLayout.setVerticalGroup(
            ...
            .addGroup(jpMenuLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jbtnItems, GroupLayout.PREFERRED_SIZE, 59, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jbtnOrders1, GroupLayout.PREFERRED_SIZE, 59, GroupLayout.PREFERRED_SIZE)
